...
// const Counter = require('../models/kuldevicategoryCounter');
...
// controllers/kuldeviCategoryController.js
...
exports.createCategory = async (req, res) => {
    ...
    try {
        const imageKey = `kuldevi-categories/${uuidv4()}_${req.file.originalname}`;
