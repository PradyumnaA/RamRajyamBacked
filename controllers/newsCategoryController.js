...
// const Counter = require('../models/newsCategoryCounter');
...
//       const id = await getNextSequenceValue('categoryId'); // Assuming this function generates a unique ID
...
exports.createCategory = async (req, res) => {
    ...
    try {
        const imageKey = `news-categories/${uuidv4()}_${req.file.originalname}`;
