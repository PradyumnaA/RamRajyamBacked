...
// const Counter = require('../models/eventsCategoryCounter');
...
// controllers/eventsCategoryController.js
...
exports.createCategory = async (req, res) => {
    ...
    try {
        const imageKey = `events-categories/${uuidv4()}_${req.file.originalname}`;
